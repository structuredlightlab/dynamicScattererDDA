...
fig_name = ['fastOptInt_v1_' color_scale];
...
switch fluct_plot_type
    ...
    fig_name = ['fastOptIntFluctuations_v1_' color_scale];
    saveFigure(fig,fig_name,save_path,{'png','fig'},0);
disp(['Testing movement with fast optimiser v1 took ' num2str(toc) ' seconds.'])