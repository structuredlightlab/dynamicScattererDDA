    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(1)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    ...
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(1)),3)],...
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(2)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    plot(real(z_dipole_positions)/(wavelength),...
        imag(z_dipole_positions)/(wavelength),'LineStyle','none',...
    ...
    plot(real(moving_dipole_positions)/(wavelength),...
        ...
        'Marker','o','MarkerSize',7,'Color',col6)
    axis image
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(2)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(3)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    plot(real(z_dipole_positions)/(wavelength),...
        imag(z_dipole_positions)/(wavelength),'LineStyle','none',...
    ...
    plot(real(moving_dipole_positions)/(wavelength),...
        ...
        'Marker','o','MarkerSize',7,'Color',col6)
    axis image
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(3)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(4)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    plot(real(z_dipole_positions)/(wavelength),...
        imag(z_dipole_positions)/(wavelength),'LineStyle','none',...
    ...
    plot(real(moving_dipole_positions)/(wavelength),...
        ...
        'Marker','o','MarkerSize',7,'Color',col6)
    axis image
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(4)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(5)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    plot(real(z_dipole_positions)/(wavelength),...
        imag(z_dipole_positions)/(wavelength),'LineStyle','none',...
    ...
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(5)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(6)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    plot(real(z_dipole_positions)/(wavelength),...
        imag(z_dipole_positions)/(wavelength),'LineStyle','none',...
    ...
    axis image
    xlabel('x, \lambda'); 
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(6)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(7)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    plot(real(z_dipole_positions)/(wavelength),...
        imag(z_dipole_positions)/(wavelength),'LineStyle','none',...
    ...
    axis image
    xlabel('x, \lambda');
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(7)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
    ...
    [tavg_field,~] = DDA_true2D(k0,alpha,z_full_2d,exclusion_radius,...
        z_sources,eigenvectors_tavg(:,idx_to_plot(8)),z_dipole_positions,show_pol_plots);
    imagesc(x_points/wavelength,x_points/wavelength,...
        abs(tavg_field).^2./max(max(abs(tavg_field(:,:)).^2)))
    ...
    axis image
    xlabel('x, \lambda'); 
    text(-0.55*scale,-0.5*scale,['abs(\lambda) = ' num2str(abs_eigvals_tavg(idx_to_plot(8)),3)],...
        'Color','black','BackgroundColor',[1 1 1 0.5],...
        'FontName','cmss10','FontSize',get(groot,'defaultAxesFontSize'));
